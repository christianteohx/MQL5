...

{
...

   {
...

      {
         ...
         {  // currentRSI > 50.0 and < rsi_overbought
...

   {
...

      {
...

         {
            ...
            {
               new_stop_loss = NormalizeDouble(RoundToTick(tick.bid - (current_atr * atr_sl_multiplier)), decimal);  // Adjust for bid at exit
            }
